...
----
<br>
Оформлен в виде сайта, реализован на языке Python с использованием фреймворка Django. Версии 3.8.8 и 3.2.7 соответственно. Эскизы отрисованы в Figma, для воплощения их в жизнь большей частью задействованы инструменты bootstrap, но c щепоткой кустарного CSS. В качестве системы управления БД оставлен стандартный SQLite3.
<br><br>
